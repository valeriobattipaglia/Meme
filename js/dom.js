...
document.getElementById("admin-product");

export const adminProductIdInput =
document.getElementById("admin-product-id");

export const deleteProductButton =
document.getElementById("delete-product-button");

export const adminQuantityInput =
document.getElementById("admin-quantita");

export const adminSingleLitersInput =
document.getElementById("admin-litri-unita");

export const adminTotalLitersInput =
document.getElementById("admin-litri-totali");

export const addPreviewLitersInput =
document.getElementById("add-preview-litri");

export const addQuantityInput =
document.getElementById("quantita");

export const addSingleLitersSelect =
document.getElementById("litri-unita");