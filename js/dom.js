...
export const photoButton = document.getElementById("open-photo-button");
export const photoInput = document.getElementById("photo-input");
export const adminMessage = document.getElementById("admin-message");
export const productInfoModal = document.getElementById("product-info-modal");
export const closeProductInfoModal = document.getElementById("close-product-info-modal");
export const productInfoTitle = document.getElementById("product-info-title");
export const productInfoContent = document.getElementById("product-info-content");
